...
class Trader:
    ...
    def run(self, state):
        ...
        if Product.SQUID_INK in self.params and Product.SQUID_INK in state.order_depths:
            # We do NOT call partner approach for SQUID_INK. Instead, your RSI code.
            rsi_orders = self.rsi_squid_ink_logic(state, trader_dict)
            result[Product.SQUID_INK] = rsi_orders
